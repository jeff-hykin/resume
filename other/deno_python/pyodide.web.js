    ...
    for (const [key, cannedResponse] of Object.entries(_fetchSource).reverse()) {
        if (fileName.endsWith(key)) {
            return Promise.resolve(
                new Response(cannedResponse.data, {
                    headers: {
...
var loadPyodide = (() => {
    ...
    var se = (e, t) => {
        ...
        $ = (e, t, o, r) => {
            if ((t && typeof t == "object") || typeof t == "function") for (let a of oe(t)) !ae.call(e, a) && a !== o && O(e, a, { get: () => t[a], enumerable: !(r = re(t, a)) || r.enumerable })
            return e
        }
    var b = (e, t, o) => ((o = e != null ? ne(ie(e)) : {}), $(t || !e || !e.__esModule ? O(o, "default", { value: e, enumerable: !0 }) : o, e)),
        ce = (e) => $(O({}, "__esModule", { value: !0 }), e)
    var Oe = {}
    ...
    g.fromString = c(function (t) {
        ...
        if (i.indexOf("@") === 0)
            var s = /@(.+?)(?::(\d+))?(?::(\d+))?$/.exec(i, ""),
                ...
                d = s[2],
                u = s[3]
        return new g({ functionName: a, args: n || void 0, fileName: l, lineNumber: d || void 0, columnNumber: u || void 0 })
    ...
    for (E = 0; E < F.length; E++)
        (g.prototype["get" + w(F[E])] = L(F[E])),
            (g.prototype["set" + w(F[E])] = (function (e) {
                return function (t) {
    ...
    for (S = 0; S < R.length; S++)
        (g.prototype["get" + w(R[S])] = L(R[S])),
            (g.prototype["set" + w(R[S])] = (function (e) {
                return function (t) {
                    this[e] = String(t)
                }
            })(R[S]))
...
`
                ...
                return a.map(function (n) {
                    ...
                    var i = n
                        ...
                        s = i.match(/ (\(.+\)$)/)
                    i = s ? i.replace(s[0], "") : i
                    var l = this.extractLocation(s ? s[1] : i),
                        d = (s && i) || void 0,
...
`
    ...
    var y = typeof process == "object" && typeof process.versions == "object" && typeof process.versions.node == "string" && !process.browser,
        ...
        pe = typeof Deno < "u",
        V = !y && !pe,
        z = V && typeof window == "object" && typeof document == "object" && typeof document.createElement == "function" && "sessionStorage" in window && typeof importScripts != "function",
    ...
    async function M() {
        ...
        let e = J,
            ...
            o = await import(/* webpackIgnore */ "ws"),
    ...
    c(G, "loadBinaryFile")
    var I
    if (z) I = c(async (e) => await import(/* webpackIgnore */ e), "loadScript")
    else if (q)
        I = c(async (e) => {
            try {
        ...
        let t = e.FS,
            ...
            a = {
                ...
                getRemoteSet: async (n) => {
                    let i = Object.create(null),
                        s = await Ee(n.opts.fileSystemHandle)
                    for (let [l, d] of s) l !== "." && (i[r.join2(n.mountpoint, l)] = { timestamp: d.kind === "file" ? (await d.getFile()).lastModifiedDate : new Date(), mode: d.kind === "file" ? a.FILE_MODE : a.DIR_MODE })
                    return { type: "remote", entries: i, handles: s }
                },
                loadLocalEntry: (n) => {
                    let s = t.lookupPath(n).node,
                        l = t.stat(n)
                ...
                reconcile: async (n, i, s) => {
                    ...
                    let u = []
                    if (
                        (Object.keys(s.entries).forEach(function (f) {
                    ...
                    for (let f of u)
                        if (s.type === "local") a.removeLocalEntry(f)
                        else {
                            let v = r.normalize(f.replace(n.mountpoint, "/")).substring(1)
    ...
    function _e(e) {
        ...
        return (o) => {
            ...
            o.FS.mkdirTree("/lib"),
                o.FS.mkdirTree(`/lib/python${r}.${a}/site-packages`),
    ...
    async function B(e = {}) {
        ...
        let o = { fullStdLib: !1, jsglobals: globalThis, stdin: globalThis.prompt ? globalThis.prompt : void 0, lockFileURL: t + "pyodide-lock.json", args: [], _node_mounts: [], env: {}, packageCacheDir: t, packages: [], enableRunUntilComplete: !1, checkAPIVersion: !0 },
            r = Object.assign(o, e)
...
var $loadPyodide = loadPyodide.loadPyodide
export { $loadPyodide as loadPyodide }
