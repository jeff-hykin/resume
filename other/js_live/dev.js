...
let latestCode = generateNewJs(await FileSystem.read(args.file), websocketAddress)
...
for await (const event of watcher) {
    latestCode = generateNewJs(await FileSystem.read(args.file), websocketAddress)
    broadcast(yaml.stringify({latestCode}))
    FileSystem.write({
